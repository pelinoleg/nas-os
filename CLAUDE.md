...
Идеи в бэклоге (для Explorer): «что изменилось» — бейджи added/changed vs предыдущая точка (kopia
diff двух манифестов), QuickLook-превью файла (эндпоинт стрима уже есть), мультивыбор для
пакетного restore/download; общие: Telegram-бот, «топ самых больших файлов» в анализаторе,
